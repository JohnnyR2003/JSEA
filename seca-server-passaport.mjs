...
const serviceMock = mockSecaServices(); // For testing purposes
...
export let app = express(); // Export for testing purposes
...
// API Routes
app.get('/popularEvents', API.getEvents);
app.get('/searchEvent/:name', API.getEventsByName);
app.get('/group', API.getGroups);
app.get('/group/details/:id', API.getGroup);
app.post('/group/create', API.createGroup);
app.post('/group/addEvent/:id', API.addEvent);
app.put('/group/editGroup/:id', API.editGroup);
app.delete('/group/delete/:id', API.deleteGroup);
app.delete('/group/removeEvent/:id/:eventid', API.removeEventFromGroup);
app.post('/user/create', API.createUser);
app.get('/group/eventDetails/:idEvent', API.getEventDetails);
